 ...
 */
final class Version20220908100910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD created_by VARCHAR(255)');
        $this->addSql('ALTER TABLE "user" ADD updated_by VARCHAR(255)');
    }
